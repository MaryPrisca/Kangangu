...
class ExamResults(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        self.sbSizer2 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, wx.EmptyString), wx.VERTICAL)
        ...
        right_container.Add(self.show_results, 1, wx.ALL | wx.EXPAND, 15)

        horizontal_sizer.Add(right_container, 5, wx.EXPAND, 5)
    ...
    def resetForm(self, event):
        ...
        self.show_results.updateResultsOLV("")  # Clear table
